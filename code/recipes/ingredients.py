...
ingredients_file = 'data/recipes/foodcom/all_ingredients.csv'
super_ingredients_file = 'data/recipes/ingredients.txt'
...
ingredients.to_csv('data/recipes/filtered.csv')
